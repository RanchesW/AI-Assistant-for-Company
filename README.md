...
1. [Сбор Данных и Настройка Доступа](#сбор-данных-и-настройка-доступа)
   - [Подключение к Базе Данных Oracle](#подключение-к-базе-данных-oracle)
   - [Сбор дополнительных данных](#сбор-дополнительных-данных)

2. [Выбор облачного сервера: AWS или Azure](#выбор-облачного-сервера-aws-или-azure)
...
3. [Развертывание AWS сервера](#развертывание-aws-сервера)
...
4. [Техническая часть внедрения](#техническая-часть-внедрения)
...
5. [OCR и Обработка Данных](#ocr-и-обработка-данных)
   - [Рассмотрение вариантов использования OCR](#рассмотрение-вариантов-использования-ocr)
   - [Интерпретация и форматирование данных](#интерпретация-и-форматирование-данных)

6. [Тестирование и Оптимизация](#тестирование-и-оптимизация)
   - [Обучение модели на данных](#обучение-модели-на-данных)
   - [Функциональное тестирование](#функциональное-тестирование)
   - [Оптимизация производительности](#оптимизация-производительности)

7. [Внедрение и Обучение](#внедрение-и-обучение)
   - [Развертывание системы](#развертывание-системы)
   - [Обучение пользователей и документация](#обучение-пользователей-и-документация)

8. [Работа Программы для Пользователей и Примеры Сценариев](#работа-программы-для-пользователей-и-примеры-сценариев)
...
9. [Поддержка и Постоянное Улучшение](#поддержка-и-постоянное-улучшение)
   - [Мониторинг и Обратная Связь](#мониторинг-и-обратная-связь)
   - [Улучшение системы](#улучшение-системы)

10. [Роли в проекте](#роли-в-проекте)
...
## 11 План по времени для разработки AI ассистента с использованием AWS и Tesseract
